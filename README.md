...
|-------|-------------|---------------------|
| `agent-docs-auditor` | Audit and improve agent steering files (CLAUDE.md, AGENTS.md, .claude/rules/) and SKILL.md files | — (Custom) |
...
| `bedrock-pr-review` | Set up AI-powered code review and auto-fix for GitHub repos using Amazon Bedrock | — (Custom) |
...
| `domain-analyst` | Design and scaffold recurring domain research reports with checkpointed pipelines, scoring transparency, and generation stats | — (Custom) |
...
| `engineering-team` | Scaffold a 3-agent engineering team (principal, security, UX) with domain expertise rules into any repo | — (Custom) |
| `feature-workflow` | End-to-end workflow for implementing features and bug fixes — design doc through PR merge | — (Custom) |
