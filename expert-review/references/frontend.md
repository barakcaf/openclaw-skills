---
description: "Frontend UX, accessibility, performance, and design system expertise"
alwaysApply: false
globs:
  - "frontend/**/*.tsx"
  - "frontend/**/*.ts"
...
<!-- ADAPT: Replace with repo-specific frontend rules (framework, naming, state, etc.) -->
