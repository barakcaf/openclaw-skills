---
description: "IaC, CI/CD, deployment, and platform engineering expertise"
alwaysApply: false
globs:
  - "**/cdk/**"
  - "**/terraform/**"
...
<!-- ADAPT: Replace with repo-specific IaC/CI rules (tool, provider, targets, etc.) -->
- ARM64/Graviton by default for all compute
